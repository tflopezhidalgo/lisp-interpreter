...
(deftest controlar-aridad-test
  (testing "con cantidad de args correcta"
    (is (= (controlar-aridad '(a b c) 3) 3)))

  (testing "con cantidad de args incorrecta"
...
(deftest error?-test
  (testing "con mensajes de error valido"
...
(deftest actualizar-env-test
  (testing "con valores validos"
    (testing "con simbolos en minuscula"
    ...
    (testing "con simbolos en mayusculas"
      (is (valores-iguales (actualizar-amb '(a 1 b 2 c 3) 'C 4) '(a 1 b 2 c 4))))

  (testing "con valores invalidos"
    (is (valores-iguales (actualizar-amb '(a 1 b 2 c 3) 'b (list '*error* 'mal 'hecho)) '(a 1 b 2 c 3))))

(deftest buscar-test
  (testing "con casos de uso"
    (testing "con simbolos existentes"
      (is (= (buscar 'c '(a 1 b 2 c 3 d 4 e 5)) 3))
      (is (= (buscar 'C '(a 1 b 2 c 3 d 4 e 5)) 3)))

    (testing "con simbolos invalidos"
